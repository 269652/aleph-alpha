...
## Per-pixel flow-DIRECTION data, not art -- see procedural_river_flow_sprite.gd
## and docs/concept/rivers.md.
...
func test_generate_image_bakes_the_normalized_angle_into_red():
	var image := sprite.generate_image(90.0)
...
func test_generate_image_is_uniform_across_the_whole_tile():
	var image := sprite.generate_image(200.0)
...
func test_generate_texture_returns_a_real_texture_of_the_right_size():
	var texture := sprite.generate_texture(45.0)
