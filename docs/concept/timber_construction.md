...
drop-back — and (2026-08-25 follow-up pass) real withering — a closed-form
decay catch-up feeding that same collapse path. Everything else this doc
describes (the settlement construction ledger, offscreen construction
