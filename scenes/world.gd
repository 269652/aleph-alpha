...
func _client_process(delta: float) -> void:
	...
	# the two loops below did the crushing.
	...
	# deliberately not fed into Karma the way the worm/caterpillar calls
	# just above are (see docs/concept/mushrooms.md, docs/concept/
	# soil_fauna.md).
